          ...
          return (
            ...
            >
              <div className="flex items-start gap-6">
                <img
                  className="w-16 sm:w-20 border border-gray-200 rounded-sm"
      ...
      <div className="flex justify-end my-20">
        <div className="w-full sm:w-[450px]">
          ...
          <div className="w-full text-end">
            <button
              onClick={() => {
                toast.info("This is a demo project and doesn't support online checkout yet.");
              }}
              className="bg-gradient-to-r from-primary to-secondary text-white text-sm my-8 px-8 py-3 hover:brightness-110"
            >
              PROCEED TO CHECKOUT
            </button>
          </div>
